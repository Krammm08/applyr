...
const ApplicantDetailsPage = ({
  ...
  const [clickedPanel, setClickedPanel] = useState<ActivePanel>({
    type: "list",
  });
  ...
  return (
    <div className="page-shell">
      {showSectionSwitchModal ? (
        <div
          className="modal-backdrop center-align"
          role="dialog"
          aria-modal="true"
        ...
        >
          <div className="modal">
            ...
            <p>
              Please submit your current section before editing another one.
            </p>
            ...
            <GroupBox title="Personal Information">
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateApplicant("applicantName", e.target.value)
                  }
              ...
              <div className="lyt_flex-row">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateApplicant("emailAddress", e.target.value)
                    }
                    disabled={isValidationBlocked}
                  />
                </div>
                ...
                {education.map((item, index) => (
                  <div key={`education-${index}`} className="section-row">
                    ...
                    <button
                      ...
                      className="row-main"
                      onClick={() =>
                        _setActivePanel({ type: "education", index })
                      }
                    >
                      <span className="row-title">
                        {formatEducationTitle(item)}
                      </span>
                      <span className="row-subtitle">
                        {formatEducationRange(item) || "Years not set"}
                      </span>
                    </button>
                    <button
                      type="button"
            ...
            >
                ...
                {employmentHistory.map((item, index) => (
                  <div key={`employment-${index}`} className="section-row">
                    ...
                    <button
                      ...
                      className="row-main"
                      onClick={() =>
                        _setActivePanel({ type: "employment", index })
                      }
                    >
                      <span className="row-title">
                        {formatEmploymentTitle(item)}
                      </span>
                      <span className="row-subtitle">
                        {item.workPosition || "Role"}
                        {formatEmploymentRange(item)
                          ? ` • ${formatEmploymentRange(item)}`
                          : ""}
                      </span>
                    </button>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  _setActivePanel({
                    type: "employment",
                    index: employmentHistory.length,
                  });
                }}
                disabled={isValidationBlocked}
              >
                ...
                {trainings.map((item, index) => (
                  <div key={`training-${index}`} className="section-row">
                    ...
                    <button
                      ...
                      className="row-main"
                      onClick={() =>
                        _setActivePanel({ type: "training", index })
                      }
                    >
                      <span className="row-title">
                        {item.trainingTitle || "Training"}
                      </span>
                      <span className="row-subtitle">
                        {item.trainingDurationHours
                          ? `${item.trainingDurationHours}h`
                          : "Duration not set"}
                      </span>
                    </button>
                    <button
                ...
                {certificates.map((item, index) => (
                  <div key={`certificate-${index}`} className="section-row">
                    ...
                    <button
                      ...
                      className="row-main"
                      onClick={() =>
                        _setActivePanel({ type: "certificate", index })
                      }
                    >
                      <span className="row-title">
                        {item.certificateName || "Certificate"}
                      </span>
                      <span className="row-subtitle">
